...
-- HOLDS THE LATEST CONFIG.YML FILE FOR A MINIFI DEVICE
CREATE TABLE IF NOT EXISTS GARCON.C2_DEVICE_CONFIG (
    DEVICE_CONFIG_ID BIGINT AUTO_INCREMENT,
    NAME VARCHAR(255) NOT NULL,
...
-- HOLDS THE MAPPING FROM DEVICES TO FLOWFILE CONFIGURATIONS
CREATE TABLE IF NOT EXISTS GARCON.C2_DEVICE_CONFIG_MAPPING (
    DEVICE_CONFIG_MAPPING_ID BIGINT AUTO_INCREMENT,
    DEVICE_ID VARCHAR(30),
    DEVICE_CONFIG_ID BIGINT,
    CONFIGURED_TS TIMESTAMP,
    DEPLOYED_TS TIMESTAMP,
    PRIMARY KEY (DEVICE_CONFIG_MAPPING_ID),
    FOREIGN KEY (DEVICE_ID) REFERENCES GARCON.C2_DEVICE (DEVICE_ID),
    FOREIGN KEY (DEVICE_CONFIG_ID) REFERENCES GARCON.C2_DEVICE_CONFIG (DEVICE_CONFIG_ID)
);