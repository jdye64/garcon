...
public class MiNiFiCPPDeviceMapper
        implements ResultSetMapper<MiNiFiCPPDevice>
{
    public MiNiFiCPPDevice map(int index, ResultSet resultSet, StatementContext statementContext) throws SQLException
    {
        MiNiFiCPPDevice mn = new MiNiFiCPPDevice();
