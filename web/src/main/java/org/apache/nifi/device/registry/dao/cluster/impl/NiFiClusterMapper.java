...
public class NiFiClusterMapper
        implements ResultSetMapper<NiFiCluster>
{
    public NiFiCluster map(int index, ResultSet resultSet, StatementContext statementContext) throws SQLException
    {
        NiFiCluster nc = new NiFiCluster();
